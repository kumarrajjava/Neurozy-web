  ...
  return (
    <Website>
      <Helmet>
        ...
        <meta name="description" content="Neurozy builds intelligent, scalable AI-driven applications. Building a billion-dollar software ecosystem for businesses and entrepreneurs." />
      </Helmet>
      <ScrollRestoration />
      <Header />
      {children}
